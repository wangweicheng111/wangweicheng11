...
<link
	...
	rel="stylesheet" type="text/css" />
<link href="js/metronic/plugins/font-awesome/css/font-awesome.min.css"
	rel="stylesheet" type="text/css" />
...
<link href=" js/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet"
	type="text/css" />
...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<p class="brand" style="font-size: 22px; color: #FFF;">
				大学生<font color="#FFCC00">租赁</font>平台 <span style="font-size: 13px;">1.0</span>
			</p>
		</div>
		<form action="login" method="post" id="loginForm">
			<div class="page-body">
				<img class="page-lock-img" src="js/metronic/img/profile/logo2.jpg"
					alt="">
   ...
   <![endif]-->
	...
	<script src="js/metronic/plugins/backstretch/jquery.backstretch.min.js"
		type="text/javascript"></script>
